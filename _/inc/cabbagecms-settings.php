...
$menu_page_slug = 'cabbagecms-options-page';
$page_title = 'CabbageCMS Options';
...
function cabbagecms_login_logo() { // use cabbage as login logo
    ...
    $cabbagecms_logo = plugins_url('../img/cabbage.png', __FILE__ );
    ?>
     <style type="text/css">
...
function cabbagecms_dashboard() { // populate dashboard widget
    ...
    echo '<img src="'. $cabbagecms_logo . '" class="cabbagecms-center" alt="More Cabbage logo" />';
    echo '<h2 class="cabbagecms-welcome">Welcome to CabbageCMS</h2>';
    echo '<p>Welcome to your CabbageCMS administration panel. From here, you can manage your More Cabbage site. If you require assistance, please visit <a href="http://morecabbage.net/"> morecabbage.net</a> and submit a support ticket. Our knowledgeable and friendly staff will quickly respond to your request. You may also email the support staff at <a href="mailto:friendlysupport@morecabbage.com">friendlysupport@morecabbage.com</a>. Thank you for choosing More Cabbage.</p>';
    echo '<em>Chris Conant</em><br />';
    echo '<small>Head Cabbage, More Cabbage</small>';
}

function cabbagecms_register_widget() { // add dashboard widget

    wp_add_dashboard_widget('cabbagecms-dashboard', 'CabbageCMS', 'cabbagecms_dashboard');
}
...
function cabbagecms_admin_init_google() { // Google Analytics and WT
    ...
    add_settings_section(
        ...
        'CabbageCMS - Analytics, Webmaster Tools and Verification Codes', // section title
...
function cabbagecms_admin_init_social_networks() { // social networks section
    ...
    add_settings_section(
        ...
        'CabbageCMS - Social Networks', // section title
